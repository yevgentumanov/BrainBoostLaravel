        ...
        <div class="col-12 pl-0 pr-0 pt-4 pb-4 cuerpo">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div id="divregistro" class="col-md-12 s-materia">
                        <div class="card pb-2">
                            <div id="v-texto" class="card-body bg-primary">
                                <h1>Verificacion de correo</h1>
                                <div class="col-12">
                                    <p>¡Gracias por registrarte! Antes de comenzar, ¿podrías verificar tu dirección de
                                        correo
                            ...
                            <div class="mt-4 row justify-content-center">
                                <form method="POST" action="{{ route('verification.send') }}">
                                    ...
                                    <div>
                                        <button type="submit" class="btn btn-5 px-4 py-2  mb-2 rounded-md">Volver a enviar
                                        </button>
                                    </div>
                                </form>
                                ...
                                <form method="POST" action="{{ route('salir') }}">
                                    ...
                                    <button type="submit" class="btn btn-5 px-4 py-2 ml-2 mb-2 rounded-md"> Salir
                                    </button>
                                </form>
                            </div>
                        </div>
