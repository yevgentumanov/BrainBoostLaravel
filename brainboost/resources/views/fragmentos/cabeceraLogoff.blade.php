...
<header>
    <div class="cabecera-log">
        ...
        <nav class="row w-100 m-0 navbar cabecera-log-nav">
            <!-- Logo -->
            <div class="col-12 col-lg-4 d-flex justify-content-center order-1">
                <a class="navbar-brand m-0" href="{{ route('index') }}">
                    <img class="m-0" src="{!! asset('images/Logo_letras_chicas_con_sombra en blanco y negro-trayectos-v3.svg') !!}" alt="logo">
                </a>
            </div>
            ...
            <div class="col-12 col-lg-2 order-2 order-md-3">
                ...
                <div class="row w-100 m-0 d-flex justify-content-center">
                    <a href="{{ route('cuenta') }}" class="btn m-2 w-100 sombra boton-sliding-abajo bt-log">Cuenta
                        usuario</a>
                </div>
            </div>
        </nav>
