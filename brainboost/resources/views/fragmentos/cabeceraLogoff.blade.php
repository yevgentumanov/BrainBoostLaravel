    ...
    <div class="cabecera-log">
        ...
        <nav class="row w-100 m-0 navbar bg-dark navbar-light sticky-top">
            ...
            <button class="navbar-toggler nav-ico" type="button" data-toggle="collapse"
                data-target="#navbarHumanidades" aria-controls="navbarHumanidades" aria-expanded="false"
            ...
            <button class="navbar-toggler nav-ico" type="button" data-toggle="collapse"
                data-target="#navbarMatematicas" aria-controls="navbarMatematicas" aria-expanded="false"
                aria-label="Toggle navigation">
                <span class=""></span>
