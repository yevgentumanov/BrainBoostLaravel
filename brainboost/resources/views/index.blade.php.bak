...
<div class="container-fluid">
        ...
        <nav class="row navbar navbar-expand-sm bg-ligth navbar-dark">
            ...
            <div class="col-6">
                <a class="row" class="navbar-brand" href="#">
                    <img class="col-4" style="margin: inherit; height: fit-content;" src="img/logo.png" alt="logo" style="width:40px;">
                </a>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a class="row d-flex justify-content-center" href="test.html">
                                    <img class="col-12" style="margin: inherit;" src="img/test.png" alt="logo" style="width:40px;">
                                </a>
                            </div>
                            <div class="col-12  d-flex justify-content-center">
                                <h3>Test 1</h3>
    ...
    <footer class="row bg-dark">
        ...
        <div class="col-12 col-md-6 col-lg-3 order-md-1 d-flex align-items-center">
            <img src="img/logo.png" height="150px" class="d-none mx-auto d-md-block" style="width: 100%; height: fit-content;" alt="Logo">
            <img src="img/logo.png" height="100px" class="mx-auto d-md-none" style="width: 100%; height: fit-content;" alt="Logo">
        </div>
    </footer>
</div>
</body>
