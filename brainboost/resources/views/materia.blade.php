            ...
            <div class="col-12">
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 1: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 2: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 3: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 4: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 5: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 6: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 7: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 8: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 9: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
                ...
                <section class="row bg-primary m-4 ">
                    <div class="col-11 p-2">
                        Test 10: temario del test relacionado
                    </div>
                    <div class="col-1 p-2">
                        (10 preguntas)
                    </div>
